...
Our ultimate goal is to build a Shiny app that allows a user to click on a state that has been shaded by its annual house price appreciation and display a chart of house prices over time. 

The final app is here:

<iframe src="https://jkr216.shinyapps.io/visualizing-usa-house-prices/" width = "100%"; height =  "600"></iframe>
